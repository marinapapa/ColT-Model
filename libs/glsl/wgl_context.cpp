...
namespace glsl { 
  ...
  class glslDummyWin
  {
    static constexpr LPCTSTR ClassName = __TEXT("{25324927-A9BE-4399-B6E9-F8F5966BB528}");
    static constexpr LPCTSTR WindowName = __TEXT("{B68FEF08-7169-4661-84C1-29B5F705099C}");
